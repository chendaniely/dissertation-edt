...
\begin{document}
    ...
    \label{sse:intro-lesson-design}
        ...
        \begin{enumerate}[label=\textbf{L.\arabic*}]
            ...
            \item \label{enum:outline} Order the formative assessments to create a course outline based on their complexity, their dependencies, and how well topics will motivate your learners.
