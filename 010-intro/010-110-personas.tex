...
\label{sse:intro-learner-personas}
    ...
    \begin{table}[ht]
        ...
        \caption[Personas vs Learner Personas]{
            How learners can be the ``user'' in product (i.e., lessson) design.
            The personas column are reprocued from \citet{pruittPersonaLifecycleKeeping2006}
    ...
    \begin{figure}[htb]
        ...
        These show the 4 personas created looking at professionaal development needs for teachers.
        }
