...
\begin{document}
    ...
    % anaysis/040-workshop/005-attendee_counts.Rmd
    % latex table generated in R 4.1.2 by xtable 1.8-4 package
    % Wed Jan 12 22:57:38 2022
    \begin{table}[!hbtp]
        \centering
    ...
    \subsection{Workshop Materials: ds4biomed}
        ...
        \cite{horstGitHubStatsIllustrations}. % TODO check that citations worked here
    ...
    \subsection{Longitudinal and Cross-Sectional Study}
        ...
        \subsubsection{Composite Scores}
            ...
            learners felt more confident in the post-workshop results than the pre-workshop,
