...
\abstract{
    ...
    creating a set of domian-specific learning materials for the biomedical scinces
    to meet the the educational gap in biomedical informatics,
    while also meeting the call for statisticans advocating for process improvements in other disciplines.
    Data science educational materials are plenty enough to become commodity.
    This provides the opporunity to create domain-specific learning materials
    to better motivate learning using real-worlk examples
    while also capuring intracies of workign with data in a specific domain.
    This dissertaiton shows how the use of persona methodologies can be combined
    ...
    (2) combine the information from persona methodology with a backwards design approach
        ...
        to curate, plan, and assess domain-spcific data science
    ...
    integrat etheir needs into the materials as a primary focus.
...
\abstractgenaud{
    ...
    many are not domain-focused and can be overwhelming to new leaners. By
