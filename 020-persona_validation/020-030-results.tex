...
\begin{document}
    ...
    \subsubsection{Factor Analysis}
        ...
        was chosen because it better suited our data (Table \ref{tab:all-good-3fa-varimax-models})
    ...
    \subsubsection{Persona Identification}
        ...
        \begin{figure}[htb!]
            ...
            \begin{subfigure}[h]{0.45\textwidth}
                ...
                {Clustered responses for Q7.2-7.}
