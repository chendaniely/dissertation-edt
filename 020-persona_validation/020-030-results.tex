...
\begin{document}
    ...
    **** completed ****\% of the survey.
    ...
    Duplicate responses were backfilled for any missing values (i.e., coalesed),
    ...
    using hierrierical clustering with Euclidean distance and Ward's clustering method
    ...
    \subsection{Survey Descriptives}
        ...
        **** survey respondents self-reported their current occupation and career stage.
        ...
        \begin{figure}[htb]
            ...
            \centering
            \includegraphics[scale=0.5]{figs/020-persona/grouped\_demographics.png}
    ...
    \subsection{Factor Analysis}
        ...
        Items with a high correlation coefficient ($\left|\rho\right| \ge 0.5$) were candidcates to be selected for factor analysis.
        ...
        These parameters reducted the number of items for factor analysis,
        while still keeping at least 1 item from each section of the survey.

        \begin{figure}[htb]
            \centering
            \includegraphics[width=0.8\linewidth]{figs/010-validation/efa\_item\_correlations.png}
            ...
            {Correlation plot of all the items in the persona survey.
             ...
             hierarchial clustering with Euclidean distance using Ward's (ward.D2) clustering method.
        ...
        However we settled on a slighly lower fit model (TIL = 0.93, RMSEA = 0.09) using principal axis factoring (PA)
        as it better suited our data (\ref{tab:all-good-3fa-varimax-models}).
